...
export function useLeaveGuard(dirty: boolean) {
  ...
  // Returned rather than rendered here: a hook can't portal on its own, and
  // the page decides where its dialog lives. Null while nothing is blocked.
  return blocker.state === 'blocked' ? (
    <ConfirmDialog title="Leave without saving?" text="Your unsaved changes will be lost."
                   confirm="Leave" onConfirm={() => blocker.proceed()}
